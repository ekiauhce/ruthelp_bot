...
INSERT INTO documents(document, category_id) VALUES
    ...
    ('копия пенсионного удостоверения родителей', 12),
    ('копия свидетельства о рождении ребенка (студента)', 12),
    ('копия паспорта', 13),
    ('справка или выписка из МФЦ о назначении выплат от государства по предоставлению убежища', 13)
